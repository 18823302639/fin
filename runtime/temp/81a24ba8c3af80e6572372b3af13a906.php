<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/www/wwwroot/finance/public/../application/admin/view/home/admin_role_add.html";i:1552439521;s:61:"/www/wwwroot/finance/application/admin/view/Public/_meta.html";i:1551859606;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<article class="page-container">
	<form action="<?php echo url('Admin/admin_role_add'); ?>" method="post" class="form form-horizontal" id="form-admin-role-add">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>角色名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="roleName" name="admin_name">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">密码：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="admin_pwd">
			</div>
		</div>
		<div class="row cl">
