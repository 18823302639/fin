<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\myphp_www\WWW\finance\public/../application/admin\view\home\login.html";i:1551864446;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<![endif]-->
<link href="/static/H-ui.admin/static/h-ui/css/H-ui.min.css" rel="stylesheet" type="text/css" />
<link href="/static/H-ui.admin/static/h-ui.admin/css/H-ui.login.css" rel="stylesheet" type="text/css" />
<link href="/static/H-ui.admin/static/h-ui.admin/css/style.css" rel="stylesheet" type="text/css" />
...
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    <form class="form form-horizontal" action="<?php echo url('Admin/login'); ?>" method="post">
      <div class="row cl">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <label for="online">
            <input type="checkbox"  id="online" value="">
            使我保持登录状态</label>
        </div>
      </div>
      <div class="row cl">
