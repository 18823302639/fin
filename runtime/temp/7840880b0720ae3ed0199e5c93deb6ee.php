<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:79:"D:\myphp_www\WWW\finance\public/../application/index\view\jindex\hkcompany.html";i:1553588586;s:64:"D:\myphp_www\WWW\finance\application\index\view\public\meta.html";i:1552361986;s:66:"D:\myphp_www\WWW\finance\application\index\view\public\header.html";i:1552387642;s:65:"D:\myphp_www\WWW\finance\application\index\view\public\jcent.html";i:1553159416;s:66:"D:\myphp_www\WWW\finance\application\index\view\public\button.html";i:1552375917;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>发票贷（增值税发票贷） -- 在线办理</title>
...
<link href="/static/H-ui.admin/lib/Hui-iconfont/1.0.8/iconfont.css" rel="stylesheet" type="text/css" />
    <style>
        .hkcompany{color:#fff;background-color:#dd514c; border-color:#dd514c}
        .hkcompany:hover,
        .hkcompany:focus,
        .hkcompany:active,
        .hkcompany.active{color:#fff;background-color:#c62b26;border-color:#c62b26}
...
<div class="container-fluid details-body finance-body">
    ...
    <div class="row hui-header text-c">
        <div class="col-xs-12">
            <p class="mt-0">发票贷<br>（增值税发票贷）</p>
            <div class="line "></div>
        </div>
    </div>

    <style>
    .details-body .hui-ones .thumbnail .btn-primary {
        height:60px;
        min-width:155px;
    }
</style>
<div class="row hui-ones text-c">
    <div class="col-xs-6 ">
        <div class="thumbnail">
            <a class="btn btn-primary radius box-shadow hongk" href="<?php echo url('Jindex/hongk'); ?>">税企贷<br>（互联网信用贷款）</a>
        </div>
    </div>
    <div class="col-xs-6">
        <div class="thumbnail">
            <a class="btn btn-primary radius box-shadow hkcompany" href="<?php echo url('Jindex/hkcompany'); ?>">发票贷<br>（增值税发票贷）</a>
        </div>
    </div>
    <div class="col-xs-6">
        <div class="thumbnail">
            <a class="btn btn-primary radius box-shadow hkpersonal" href="<?php echo url('Jindex/hkpersonal'); ?>">产业链融资<br>（客户交易数据贷）</a>
        </div>
    </div>
    <div class="col-xs-6">
        <div class="thumbnail">
            <a style="line-height:45px;" class="btn btn-primary radius box-shadow scr_remarks" href="<?php echo url('Jindex/scr_remarks'); ?>">更多<br>&nbsp;</a>
        </div>
    </div>
</div>
    ...
    <div class="row hui-toos">
        <div class="col-xs-12"><!--action="hongk.html" method="post"-->
            <form action="<?php echo url('Jindex/hkcompany'); ?>" method="post"  class="form form-horizontal" id="signupForm" enctype="multipart/form-data">
                <div class="row cl">
                    <input type="hidden" name="category_id" value="发票贷">
                    <label class="form-label col-xs-3 col-sm-3">姓名：</label>
                    <div class="formControls col-xs-9 col-sm-9">
                        <input type="text" class="input-text" name="category_name" autocomplete="off" placeholder="请输入您的姓名" required="required" >
                    </div>
                </div>
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-9 col-sm-9">
                        <input type="file"  class="input-text" name="file_image"  >
                    </div>
                </div>

                <div class="row cl">
                    <label class="form-label col-xs-3 col-sm-3">贷款金额：</label>
                    <div class="formControls col-xs-9 col-sm-9">
                        <input type="text" path="fin_number" required="required" class="input-text" name="fin_number"  placeholder="请输入金额">
                    </div>
                </div>
