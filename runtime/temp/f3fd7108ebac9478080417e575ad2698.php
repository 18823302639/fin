<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:90:"D:\myphp_www\WWW\finance\public/../application/index\view\index\company_opens_ccounts.html";i:1552558610;s:64:"D:\myphp_www\WWW\finance\application\index\view\public\meta.html";i:1552361986;s:66:"D:\myphp_www\WWW\finance\application\index\view\public\header.html";i:1552387642;s:67:"D:\myphp_www\WWW\finance\application\index\view\public\cc_cent.html";i:1552556916;s:66:"D:\myphp_www\WWW\finance\application\index\view\public\button.html";i:1552375917;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>香港银行公司开户 -- 在线办理</title>
...
<div class="container-fluid details-body finance-body">
    ...
    <div class="col-xs-6">
        <div class="thumbnail">
            <a class="btn btn-primary radius box-shadow  scr_remarks" href="<?php echo url('Index/company_opens_ccounts'); ?>">香港银行公司开户</a>
        </div>
    </div>
    <div class="col-xs-6">
        <div class="thumbnail">
            <a class="btn btn-primary radius box-shadow hkpersonal" href="<?php echo url('Index/company_ccounts'); ?>">香港银行个人开户</a>
        </div>
    </div>
</div>
    ...
    <div class="row hui-toos">
        <div class="col-xs-12"><!--action="hongk.html" method="post"-->
            <form action="<?php echo url('Index/hongk'); ?>" method="post"  class="form form-horizontal" id="signupForm">
                <div class="row cl">
                    <input type="hidden" name="category_id" value="香港银行公司开户">
