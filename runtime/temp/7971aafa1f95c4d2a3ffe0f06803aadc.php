...
<link href="/static/H-ui.admin/lib/Hui-iconfont/1.0.8/iconfont.css" rel="stylesheet" type="text/css" />
    <style>
        .hkpersonal{color:#fff;background-color:#dd514c; border-color:#dd514c}
        .hkpersonal:hover,
        .hkpersonal:focus,
        .hkpersonal:active,
        .hkpersonal.active{color:#fff;background-color:#c62b26;border-color:#c62b26}
...
<div class="container-fluid details-body finance-body">
    ...
    <div class="row hui-header text-c">
        <div class="col-xs-12">
            <p class="mt-0">产业链融资<br>（客户交易数据贷）</p>
            <div class="line "></div>
        </div>
    </div>
...
<div class="row hui-ones text-c">
    ...
    <div class="row hui-toos">
        <div class="col-xs-12"><!--action="hongk.html" method="post"-->
            <form action="<?php echo url('Jindex/hongk'); ?>" method="post"  class="form form-horizontal" id="signupForm">
                <div class="row cl">
                    <input type="hidden" name="category_id" value="产业链融资">
