<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:69:"/www/wwwroot/finance/public/../application/admin/view/home/index.html";i:1552383404;s:61:"/www/wwwroot/finance/application/admin/view/Public/_meta.html";i:1551859606;s:63:"/www/wwwroot/finance/application/admin/view/Public/_header.html";i:1551864823;s:61:"/www/wwwroot/finance/application/admin/view/Public/_menu.html";i:1552384720;s:63:"/www/wwwroot/finance/application/admin/view/Public/_footer.html";i:1551859723;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
	...
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">H-ui.admin</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a> <span class="logo navbar-slogan f-l mr-10 hidden-xs">v3.1</span> <a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="javascript:;">&#xe667;</a>
			...
			<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
				<ul class="cl">
					<li><?php echo \think\Session::get('name'); ?></li>
					<li class="dropDown dropDown_hover"> <a href="#" class="dropDown_A">admin <i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
							<li><a href="#">个人信息</a></li>
							<li><a href="#">切换账户</a></li>
							<li><a href="<?php echo url('Admin/unsess'); ?>">退出</a></li>
						</ul>
					</li>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl id="menu-comments">
			<dt><i class="Hui-iconfont">&#xe622;</i> 用户提交管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="<?php echo url('Category/product_brand_list'); ?>" data-title="评论列表" href="javascript:;">用户提交数据</a></li>
		...
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a data-href="<?php echo url('/article_list'); ?>" data-title="资讯管理" href="javascript:void(0)">资讯管理</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-picture">
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a data-href="<?php echo url('Category/product_brand'); ?>" data-title="品牌管理" href="javascript:void(0)">品牌管理</a></li>
					<li><a data-href="<?php echo url('Category/product_category'); ?>" data-title="分类管理" href="javascript:void(0)">分类管理</a></li>
					<li><a data-href="<?php echo url('Category/product_category_add'); ?>" data-title="分类管理" href="javascript:void(0)">添加分类</a></li>
					<li><a data-href="<?php echo url('Category/product_list'); ?>" data-title="产品管理" href="javascript:void(0)">产品管理</a></li>
				</ul>
			</dd>
		</dl>
