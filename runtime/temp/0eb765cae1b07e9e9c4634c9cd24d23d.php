...
<link href="/static/H-ui.admin/lib/Hui-iconfont/1.0.8/iconfont.css" rel="stylesheet" type="text/css" />
    <style>
        .scr_remarks{color:#fff;background-color:#dd514c; border-color:#dd514c}
        .scr_remarks:hover,
        .scr_remarks:focus,
        .scr_remarks:active,
        .scr_remarks.active{color:#fff;background-color:#c62b26;border-color:#c62b26}
    </style>
</head>
<style>
    .scrtop {
    ...
    <div class="row hui-toos">
        <div class="col-xs-12"><!--action="hongk.html" method="post"-->
            <form action="<?php echo url('Jindex/hongk'); ?>" method="post"  class="form form-horizontal" id="signupForm">
                <div class="row cl">
                    <input type="hidden" name="category_id" value="其他贷款">
